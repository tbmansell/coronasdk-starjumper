...
function enemy:shoot()
    ...
    after(600, function()
        ...
        -- NOTE: the shot has been generated by the level, which has already added it to its maste collection and generated its key
        self:bind(shot)
        -- Fire it off
...
function enemy:checkShouldShoot()
    if self.canShoot and self.mode == stateActive and self.action == actionNothing and #self.boundItems < self.itemsMax then
        self.canShoot = false
