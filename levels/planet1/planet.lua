local planetData = {
    ...
    zones = {
        ...
        [7]  = { x=1180, y=375, hint={gearGlider,      gearGloves},                       special=true},
        ...
        [14] = { x=2290, y=370, hint={gearTrajectory,  gearGloves},                       special=true},
    ...
    -- Background sounds
    backgroundSounds = {
        {name="nature/wind2", quietTime=7000, minVolume=1, maxVolume=3},
        {name="nature/wind3", quietTime=5000, minVolume=1, maxVolume=3},
    },
