local levelData = {
    ...
    elements = {
        {object="ledge", type="start"},
            ...
            {object="spike", x=400,  y=-770,  type="fg-spikes-float-1", size=0.5, layer=2, copy=12, gap=-80},
            ...
            {object="spike",   x=1090, y=-1370, type="fg-spikes-float-1", size=0.5, layer=2, copy=8, gap=-40 },
