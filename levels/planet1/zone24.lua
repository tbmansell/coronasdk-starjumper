local levelData = {
    ...
    elements = {
        ...
        {object="ledge", x=450, y=-150, size="medium", length=150, 
            movement={pattern=movePatternCircular, speed=1, arcStart=0, arc=360, fullCircle=true}
        },
        ...
        {object="ledge", x=450, y=-100, size="medium", length=150, 
            movement={pattern=movePatternCircular, speed=1.5, arcStart=360, arc=0, fullCircle=true}
        },
